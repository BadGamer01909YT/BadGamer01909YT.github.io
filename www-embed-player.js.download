...
sb.prototype.N=!0;sb.prototype.L=function(){return this.f.toString()};
...
I.prototype.N=!0;I.prototype.L=function(){return this.f.toString()};
...
Ob.prototype.N=!0;Ob.prototype.L=function(){return this.f.toString()};
...
function Dc(a,b){fb(b,function(c,d){c&&"object"==typeof c&&c.N&&(c=c.L());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Ec.hasOwnProperty(d)?a.setAttribute(Ec[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
function b(p){for(var r=g,q=0;64>q;q+=4)r[q/4]=p[q]<<24|p[q+1]<<16|p[q+2]<<8|p[q+3];for(q=16;80>q;q++)p=r[q-3]^r[q-8]^r[q-14]^r[q-16],r[q]=(p<<1|p>>>31)&4294967295;p=e[0];var A=e[1],D=e[2],U=e[3],hd=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var Wa=U^A&(D^U);var Vb=1518500249}else Wa=A^D^U,Vb=1859775393;else 60>q?(Wa=A&D|U&(A|D),Vb=2400959708):(Wa=A^D^U,Vb=3395469782);Wa=((p<<5|p>>>27)&4294967295)+Wa+hd+Vb+r[q]&4294967295;hd=U;U=D;D=(A<<30|A>>>2)&4294967295;A=p;p=Wa}e[0]=e[0]+p&4294967295;e[1]=e[1]+
...
var rd=!1,sd=new ld;function td(){for(var a;a=sd.remove();){try{a.f.call(a.scope)}catch(b){id(b)}gd(nd,a)}rd=!1}
...
n.o=function(){P.O.o.call(this);this.clear();this.i.length=0};function ke(a){this.f=a}
...
F(oe,le);oe.prototype.set=function(a,b,c){if(b=ne(b)){if(c){if(c<E()){oe.prototype.remove.call(this,a);return}b.expiration=c}b.creation=E()}oe.O.set.call(this,a,b)};
oe.prototype.g=function(a){var b=oe.O.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<E()||c&&c>E())oe.prototype.remove.call(this,a);else return b}};function pe(){}
;function qe(){}
...
function $e(a){var b=window.location.search,c=K(a),d=Xb(a.match(Wb)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Le(b),f={};H(Xe,function(g){e[g]&&(f[g]=e[g])});
return Me(a,f||{},!1)}
...
;var mf={},nf=0;
function of(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!lf("cobalt")){if(a){a instanceof I||(a="object"==typeof a&&a.N?a.L():String(a),Ib.test(a)?a=new I(a,Eb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Hb))&&Gb.test(b[1])?new I(a,Eb):null));a=Fb(a||Kb);if("about:invalid#zClosurez"===a||a.startsWith("data"))a="";else{if(!(a instanceof Ob)){b="object"==typeof a;var f=null;b&&a.ja&&(f=a.ga());a=Qb(wb(b&&a.N?a.L():String(a)),f)}a instanceof Ob&&a.constructor===Ob?a=a.f:(Ja(a),a="type_error:SafeHtml");
...
function vh(a,b,c){a=a.f.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return wh(a).then(function(d){return ih(d,c)})}
...
function li(){return N(this,function b(){return x(b,function(c){return T("networkless_logging")?(2===Se("networkless_ytidb_version")&&Ih().then(function(d){return d}),c["return"](Eh())):c["return"](!1)})})}
...
(window&&window.yterr||g)&&!(5<=wi)&&0!==a.sampleWeight)){var h=tc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.f||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var r=c,q=0;q<m.length&&!(m[q]&&(k+=Ai(q,m[q],p,r),500<k));q++);else if("object"===typeof m)for(r in r=void 0,q=c,m){if(m[r]&&
(k+=Ai(r,m[r],p,q),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,r=String(JSON.stringify(m[l])).substr(0,500),c[k]=r,p+=k.length+r.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c.vendor=
...
if(!(vi.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){ui.M("handleError",c);if(T("kevlar_gel_error_routing")){a=b;a:{g=u(xi);for(d=g.next();!d.done;d=g.next())if(lf(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);d=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==d.length&&(1!==d.length||isNaN(Number(d[0]))?2!==d.length||isNaN(Number(d[0]))||isNaN(Number(d[1]))||(g.lineNumber=Number(d[0]),
...
Bi.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Kf(b,function(){g.g=!1;window.botguard?Ci(g,c,d,f):(Pf(b),yi(new oi("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Ci(this,c,d,f):yi(Error("Unable to load Botguard from JS")))};
...
return a.join("")}
;var Ii=y.ytLoggingDocDocumentNonce_||Hi();z("ytLoggingDocDocumentNonce_",Ii,void 0);var Ji=1;function Ki(a){this.f=a}
...
z("yt_logging_screen.getRootVeType",Ni,void 0);function Oi(){var a=Ni(0),b;a?b=new Ki({veType:a,youtubeData:void 0}):b=null;return b}
...
z("yt_logging_screen.getCurrentCsn",Qi,void 0);function Ri(a,b,c){var d=Pi();(c=Qi(c))&&delete d[c];b&&(d[a]=b)}
function Si(a){return Pi()[a]}
z("yt_logging_screen.getCttAuthInfo",Si,void 0);function Ti(a,b,c,d){c=void 0===c?0:c;if(a!==R(Li(c))||b!==R(Mi(c)))if(Ri(a,d,c),Q(Li(c),a),Q(Mi(c),b),0==c||T("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&Mg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Ii,clientScreenNonce:a},pi)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",Ti,void 0);function Ui(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=K(window.location.href);g&&f.push(g);g=K(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(T("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Wb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Qi()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Ub(d).toString(36),e=e?Zb(e):"",tf(b,e,k||5))}else k=b,e="ST-"+Ub(d).toString(36),k=k?Zb(k):"",tf(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=$b(a,l)+m;a=a instanceof I?a:Jb(a);c.href=Fb(a)}return!0}
;function Vi(a,b){this.version=a;this.args=b}
;function Wi(a,b){this.topic=a;this.f=b}
Wi.prototype.toString=function(){return this.topic};var Xi=B("ytPubsub2Pubsub2Instance")||new P;P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.P;P.prototype.publish=P.prototype.M;P.prototype.clear=P.prototype.clear;z("ytPubsub2Pubsub2Instance",Xi,void 0);var Yi=B("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",Yi,void 0);var Zi=B("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",Zi,void 0);var $i=B("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",$i,void 0);
z("ytPubsub2Pubsub2SkipSubKey",null,void 0);function aj(a,b){var c=bj();c&&c.publish.call(c,a.toString(),a,b)}
...
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){S(p)}},$i[b.toString()]?B("yt.scheduler.instance")?Uf(g):V(g,0):g())});
...
c=u(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&yi(Error("Child VE logged with no data"));c={fa:Si(a),S:a};"UNDEFINED_CSN"==a?lj("visualElementAttached",b,c):d?Mg("visualElementAttached",b,d,c):qi("visualElementAttached",b,c)}
function lj(a,b,c){ij.push({payloadName:a,payload:b,options:c});jj||(jj=ej())}
function fj(a){if(ij){for(var b=u(ij),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Mg(c.payloadName,c.payload,null,c.options));ij.length=0}jj=0}
...
mj.prototype.clone=function(){var a=new mj,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ja(c)?a[b]=mb(c):a[b]=c}return a};function nj(){M.call(this);this.f=[]}
v(nj,M);nj.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.Ca)}M.prototype.o.call(this)};var oj=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function pj(a){a=a||"";if(window.spf){var b=a.match(oj);spf.style.load(a,b?b[1]:"",void 0)}else qj(a)}
function qj(a){var b=rj(a),c=document.getElementById(b),d=c&&wf(c,"loaded");d||c&&!d||(c=sj(a,b,function(){wf(c,"loaded")||(uf(c),Ff(b),V(Sa(Gf,b),0))}))}
...
;function tj(a,b,c,d){M.call(this);var e=this;this.m=this.Z=a;this.W=b;this.u=!1;this.api={};this.X=this.F=null;this.G=new P;Rc(this,Sa(Sc,this.G));this.j={};this.T=this.Y=this.h=this.ea=this.f=null;this.K=!1;this.l=this.C=null;this.aa={};this.za=["onReady"];this.da=null;this.na=NaN;this.U={};this.i=d;uj(this);this.ba("WATCH_LATER_VIDEO_ADDED",this.Sa.bind(this));this.ba("WATCH_LATER_VIDEO_REMOVED",this.Ta.bind(this));this.ba("onAdAnnounce",this.Ba.bind(this));this.Aa=new nj(this);Rc(this,Sa(Sc,this.Aa));
this.V=0;c?this.V=V(function(){e.loadNewVideoConfig(c)},0):d&&(vj(this),wj(this))}
v(tj,M);n=tj.prototype;n.getId=function(){return this.W};
n.loadNewVideoConfig=function(a){if(!this.g){this.V&&(W(this.V),this.V=0);a instanceof mj||(a=new mj(a));this.ea=a;this.f=a.clone();vj(this);this.Y||(this.Y=xj(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Xc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Xc(Number(a)||a);wj(this);this.u&&yj(this)}};
function vj(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.W,a.f.attrs.id=a.W);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
...
function zj(a){var b=!0,c=Aj(a);c&&a.f&&(a=Bj(a),b=wf(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function wj(a){if(!a.g&&!a.K){var b=zj(a);if(b&&"html5"==(Aj(a)?"html5":null))a.T="html5",a.u||Cj(a);else if(Dj(a),a.T="html5",b&&a.l)a.Z.appendChild(a.l),Cj(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.C=function(){c=!0;var d=Ej(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.Z,e,a.i);Cj(a)};
a.K=!0;b?a.C():(Kf(Bj(a),a.C),(b=a.i?a.i.cssUrl:a.f.assets.css)&&pj(b),Fj(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Aj(a){var b=Cc(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function Cj(a){if(!a.g){var b=Aj(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,!Ej(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Gj(a)):a.na=V(function(){Cj(a)},50)}}
function Gj(a){uj(a);a.u=!0;var b=Aj(a);b.addEventListener&&(a.F=Hj(a,b,"addEventListener"));b.removeEventListener&&(a.X=Hj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Hj(a,b,e))}for(var f in a.j)a.F(f,a.j[f]);yj(a);a.Y&&a.Y(a.api);a.G.M("onReady",a.api)}
function Hj(a,b,c){var d=b[c];return function(){try{return a.da=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.da=e,Ie(e))}}}
function uj(a){a.u=!1;if(a.X)for(var b in a.j)a.X(b,a.j[b]);for(var c in a.U)W(parseInt(c,10));a.U={};a.F=null;a.X=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ba.bind(a);a.api.removeEventListener=a.Xa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ha.bind(a);a.api.getPlayerType=a.Ia.bind(a);a.api.getCurrentVideoConfig=a.Ga.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ra.bind(a)}
n.Ra=function(){return this.u};
n.ba=function(a,b){var c=this,d=xj(this,b);if(d){if(!(0<=Ya(this.za,a)||this.j[a])){var e=Ij(this,a);this.F&&this.F(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.u&&V(function(){d(c.api)},0)}};
n.Xa=function(a,b){if(!this.g){var c=xj(this,b);c&&ie(this.G,a,c)}};
function xj(a,b){var c=b;if("string"==typeof b){if(a.aa[b])return a.aa[b];c=function(){var d=B(b);d&&d.apply(y,arguments)};
a.aa[b]=c}return c?c:null}
function Ij(a,b){var c="ytPlayer"+b+a.W;a.j[b]=c;y[c]=function(d){var e=V(function(){if(!a.g){a.G.M(b,d);var f=a.U,g=String(e);g in f&&delete f[g]}},0);
kb(a.U,String(e))};
return c}
...
n.Ia=function(){return this.T||(Aj(this)?"html5":null)};
n.Ha=function(){return this.da};
function Dj(a){a.cancel();uj(a);a.T=null;a.f&&(a.f.loaded=!1);var b=Aj(a);b&&(zj(a)||!Fj(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.Z;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.C){var a=Bj(this);Qf(a,this.C)}W(this.na);this.K=!1};
n.o=function(){Dj(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){S(b)}this.aa=null;for(var a in this.j)y[this.j[a]]=null;this.ea=this.f=this.api=null;delete this.Z;delete this.m;M.prototype.o.call(this)};
...
;function Rj(a){a=void 0===a?!1:a;M.call(this);this.f=new P(a);Rc(this,Sa(Sc,this.f))}
F(Rj,M);Rj.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
Rj.prototype.j=function(a,b){this.g||this.f.M.apply(this.f,arguments)};function Sj(a,b,c){Rj.call(this);this.h=a;this.i=b;this.l=c}
v(Sj,Rj);function Tj(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Kd(a),d.i))}}
Sj.prototype.o=function(){this.i=this.h=null;Rj.prototype.o.call(this)};function Uj(a){M.call(this);this.f=a;this.f.subscribe("command",this.xa,this);this.h={};this.j=!1}
v(Uj,M);n=Uj.prototype;n.start=function(){this.j||this.g||(this.j=!0,Tj(this.f,"RECEIVING"))};
...
n.Za=function(a,b){this.j&&!this.g&&Tj(this.f,a,this.ha(a,b))};
n.ha=function(a,b){if(null!=b)return{value:b}};
function Vj(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||ie(a.f,"command",this.xa,this);this.f=null;for(var b in this.h)Vj(this,b);M.prototype.o.call(this)};function Yj(a,b){Uj.call(this,b);this.i=a;this.start()}
...
Yj.prototype.ha=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Uj.prototype.ha.call(this,a,b)};
Yj.prototype.o=function(){Uj.prototype.o.call(this);delete this.i};function Zj(a,b,c){M.call(this);var d=this;c=c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.C=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.C&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(Zj,M);Zj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Ie(e)}}};
Zj.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function ak(){var a=this.g=new Zj(!!R("WIDGET_ID_ENFORCE")),b=C(this.Wa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=R("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=ak.prototype;n.Wa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,bk(this,a)),this.j[a]=!0)):this.ta(a,b,c)};
n.ta=function(){};
...
n.dispose=function(){this.g=null};function dk(a){ak.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.Ua,this));this.addEventListener("onVideoProgress",C(this.eb,this));this.addEventListener("onVolumeChange",C(this.fb,this));this.addEventListener("onApiChange",C(this.Ya,this));this.addEventListener("onPlaybackQualityChange",C(this.ab,this));this.addEventListener("onPlaybackRateChange",C(this.bb,this));this.addEventListener("onStateChange",C(this.cb,this));this.addEventListener("onWebglSettingsChanged",C(this.gb,
this))}
v(dk,ak);n=dk.prototype;n.ta=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Nj(a)){var d=b;if(Ma(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Pj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Oj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Qj.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Nj(a)&&ck(this,this.ia())}};
...
n.ab=function(a){ck(this,{playbackQuality:a})};
n.bb=function(a){ck(this,{playbackRate:a})};
...
n.fb=function(){ck(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.eb=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:E()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ck(this,a)};
n.gb=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ck(this,a)};
n.dispose=function(){ak.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function ek(a,b,c){M.call(this);this.f=a;this.i=c;this.j=hg(window,"message",C(this.l,this));this.h=new Sj(this,a,b);Rc(this,Sa(Sc,this.h))}
v(ek,M);ek.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ek.prototype.o=function(){ig(this.j);this.f=null;M.prototype.o.call(this)};function fk(){var a=mb(gk),b;return Yd(new O(function(c,d){a.onSuccess=function(e){Ve(e)?c(e):d(new hk("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new hk("Unknown request error","net.unknown",e))};
a.R=function(e){d(new hk("Request timed out","net.timeout",e))};
...
function qk(a,b){V(function(){Yd(fk().then(ok,function(c){return pk(b,c)}),Ha)},a)}
function rk(){try{var a=B("yt.ads.biscotti.getId_");return a?a():De()}catch(b){return Wd(b)}}
;function sk(a){if("1"!==gb(Be(),"args","privembed")){a&&Ce();try{rk().then(function(){},function(){}),V(sk,18E5)}catch(b){S(b)}}}
;var Y=B("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function tk(){this.f=R("ALT_PREF_COOKIE_NAME","PREF");var a=yc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
...
;function Qk(){var a=B("ytcsi.debug");a||(a=[],z("ytcsi.debug",a,void 0),z("ytcsi.reference",{},void 0));return a}
...
;var Sk=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",Sk,void 0);function Tk(){this.f=0}
...
function Vk(a,b){Sk[b]=Sk[b]||{count:0};var c=Sk[b];c.count++;c.time=X();a.f||(a.f=Sf(function(){var d=X(),e;for(e in Sk)Sk[e]&&6E4<d-Sk[e].time&&delete Sk[e];a&&(a.f=0)},5E3));
...
function pl(a){var b=Qi(),c=kl[a.id];if(b&&c){a=T("use_default_events_client")?void 0:pi;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={fa:Si(b),S:b};"UNDEFINED_CSN"==b?lj("visualElementGestured",c,d):a?Mg("visualElementGestured",c,a,d):qi("visualElementGestured",c,d)}}
function ql(a){a=a.ids;var b=Qi();if(b)for(var c=0;c<a.length;c++){var d=kl[a[c]];if(d){var e=b,f=T("use_default_events_client")?void 0:pi;d={csn:e,ve:d.getAsJson(),eventType:1};var g={fa:Si(e),S:e};"UNDEFINED_CSN"==e?lj("visualElementShown",d,g):f?Mg("visualElementShown",d,f,g):qi("visualElementShown",d,g)}}}
;z("yt.setConfig",Q,void 0);z("yt.config.set",Q,void 0);z("yt.setMsg",sf,void 0);z("yt.msgs.set",sf,void 0);z("yt.logging.errors.log",zi,void 0);
z("writeEmbed",function(){var a=R("PLAYER_CONFIG",void 0);if(!a){var b=R("PLAYER_VARS",void 0);b&&(a={args:b})}sk(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");a.args.forced_experiments||(b=window.location.href,-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=Le(1<b.length?b[1]:b[0])):b={},b.forced_experiments&&(a.args.forced_experiments=b.forced_experiments));a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=R("POST_MESSAGE_ORIGIN");
...
R("ENABLE_JS_API")?jl=new dk(a):R("ENABLE_POST_API")&&"string"===typeof c&&"string"===typeof b&&(il=new ek(window.parent,c,b),jl=new Yj(a,il.h));Zf()},void 0);
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();R("PL_ATT")&&Di.dispose();a=0;for(var b=Xf.length;a<b;a++)Wf(Xf[a]);Xf.length=0;Pf("//static.doubleclick.net/instream/ad_status.js");Yf=!1;Q("DCLKSTAT",0);Tc(jl,il);if(a=hl)a.removeEventListener("onScreenChanged",nl),a.removeEventListener("onLogClientVeCreated",ll),a.removeEventListener("onLogServerVeCreated",ol),a.removeEventListener("onLogVeClicked",pl),a.removeEventListener("onLogVesShown",ql),a.removeEventListener("onVideoDataChange",ml),a.destroy();
kl={}});
window.addEventListener?(window.addEventListener("load",rl),window.addEventListener("unload",sl)):window.attachEvent&&(window.attachEvent("onload",rl),window.attachEvent("onunload",sl));Ta("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Ei);Ta("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Fi);Ta("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||$f);
Ta("yt.player.exports.navigate",B("yt.player.exports.navigate")||Ui);Ta("yt.util.activity.init",B("yt.util.activity.init")||mg);Ta("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||pg);Ta("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||ng);}).call(this);
